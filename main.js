...
var dodger = {
    ...
    create: function() {
        // Configuration et affichage du jeu
    ...
    ajouterUnMechant: function() {
        var position = Math.floor(Math.random() * 550) + 1; // Arrondissement et positionnement du méchant
        ...
        mechant.checkWorldBounds = true; // Vérifie le placement sur l'écran
        mechant.outOfBoundsKill = true; // Si en dehors du jeu alors on le kill
    }
};
